...
// ------------------------------ Includes ------------------------------------
#include "systems/database.pwn"
#include "systems/player_data.pwn" // เพิ่มเพื่อใช้ PlayerBoolData / PlayerIntData
#include "systems/loads_systems.pwn"
#include "systems/save_systems.pwn"
...
stock SetPlayerSpawn(playerid) {
    SetSpawnInfo(playerid, 0, 0, 1172.02, -1323.89, 15.00, 0.0);
